...
public final class MetaDataUtils {
    ...
    public static String getMetaDataInApp(@NonNull final String key) {
        String value = "";
        PackageManager pm = SubUtils.getApp().getPackageManager();
        String packageName = SubUtils.getApp().getPackageName();
        try {
    ...
    public static String getMetaDataInActivity(@NonNull final Class<? extends Activity> clz,
        ...
        String value = "";
        PackageManager pm = SubUtils.getApp().getPackageManager();
        ComponentName componentName = new ComponentName(SubUtils.getApp(), clz);
        try {
