...
public class FastBlurUtils {
    ...
    public static void blur(Context context, Bitmap bkg, View view) {
        ...
        float scaleFactor = 8;
        //放大到整个view的大小
        bkg = DrawableProviderUtils.getReSizeBitmap(bkg, view.getMeasuredWidth(), view.getMeasuredHeight());
    ...
    public static Bitmap blurBitmap(Bitmap bkg, int width, int height) {
        ...
        float scaleFactor = 8;
        //放大到整个view的大小
        bkg = DrawableProviderUtils.getReSizeBitmap(bkg, width, height);
